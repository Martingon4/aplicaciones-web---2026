window.addEventListener("DOMContentLoaded", () => {
  const horoscopes = [
    ...
    { name: "Escorpio", dates: "23 Oct - 21 Nov", color: "#02630f", prediction: "Durante esta jornada, sentirá una gran contradicción entre sus propios deseos y lo que tiene, no se ahogue en ellos. Crea en usted mismo y todo saldrá como esperaba.", image: "img/escorpion.png" },
